...
参加者は予選前に安全検査のみを実施します。規格審査は予選勝者のみ実施します。__
...
予選ビーチフラグバトル対戦順リストは、ウェブサイトにて事前に公開します。(認定大会が3月1日まで開催されていますので公開は3月2日となります。)　こちらに自分のロボットが掲載されていない場合は、イベント開催日前に当協会へご連絡をお願いします。なおランキング三位までのロボットおよび認定権を取得しているロボットは予選ビーチフラグバトルには参加できません。
...
__※予選ビーチフラグバトル勝者が規格審査に落ちた場合は、その場で失格となり、残りのロボットにより対戦しその勝者が予選通過となります。対戦相手をお呼び出しする可能性がありますので、負けてしまった場合でも第一回戦のすべての試合が終わるまでは会場内に待機してください。__
再試合はすべての試合が終了後に実施します。
