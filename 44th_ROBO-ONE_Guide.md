...
### 予選バトルの集合時間
9月20日 AM9:00から入場できます。

自身の試合時間までに安全検査が完了するよう、各自の判断で集合してください。

※試合時間に間に合わなかった場合は失格になります。
...
### 受付
建物正面口から入場し、入口から3階の選手控室へお進みください。入口のスタッフに参加証を提示し、タグを受け取ってください。会場内にいる間は参加証を首から下げて移動してください。防犯のため参加証がない方は、選手控室への入室をお断ります。

__※参加証は、同伴者も必要です。必ず人数分ご準備ください。参加証をお持ちでない方は会場に入れません。__
...
※ ご帰宅の際は、タグは3F選手控室の回収箱にお戻しください。

### 選手控室
選手控室は、3Fに2個所ご用意しています。海外からご参加の皆さんは研修室2にお入りください。国内の選手は研修室1です。選手控室の席の指定はありませんので空いている席をご利用ください。
...
※受付、規格審査は1Fで受け付けています。規格審査を通過していないロボットは失格になります。また、3F選手控室には、ご連絡がいきわたらない可能性があります。ご自身で試合の進行を確認しながら待機し、自身の順番5番前ほどになりましたら「選手待機場所」へ移動してください。

※はんだ作業は所定の場所で行ってください。はんだごてのスペースは、規格審査場の脇に用意しています。
...
### アンケートへご協力ください
__第44回ROBO-ONE参加者向けにウェブアンケートを実施します。アンケートを行うには以下にアクセスしてください。9月20日15：00までにお答えください。アンケートにご協力いただいた方の中から、抽選で10名様にROBO-ONEオリジナルバッグをプレゼントします。抽選会は9月20日の閉会式で実施します。__

[アンケート](https://www.robo-one.com/qnaires/index/19)　

__※ マイページへのログインした状態でアンケートのリンクを押してください。__
...
__※	会場内で審査が通っていないバッテリーの使用を禁止します。充電も禁止です。不良バッテリーは持ち込まないようにお願いします。__

__※	バッテリーの管理には十分にご注意ください。充電中は必ずチームのメンバーが管理し、全員が席を離れる場合は充電を停止してから離れてください。管理ができる範囲で、バッテリーをご持参ください。__

__※	バッテリーは必ず専用のセーフティバッグに入れて持ち運んでください。__

__※	控室のテーブルは、会場からお借りしているものですので傷つけないようにマットなどを敷いてご利用ください。__

### 安全検査（バッテリー審査、他）【重要】
9月20日は試合開始前に「安全検査」を実施します。安全検査は、9:00より1Fホワイエにある規格審査の会場で受け付けます。安全検査を受けていない選手は試合に出場できません。詳しくは競技規則P.5の「安全検査」に関する項目をご確認ください。安全検査は規格審査とは別になりますのでご注意ください。規格審査については下記の内容をご確認ください。
...
__※これまで貼ってあるバッテリー審査シールはすべてはがしてお持ちください。__

__※朝の混雑時は、安全検査と同時に規格審査を受け付けない場合があります。ご了承ください。__

## 規格審査
### ＜予選バトルの規格審査（9月20日）＞
予選バトル一回戦勝者は、ロボットをお持ちになり、規格審査を受けてください。規格審査の会場は1Fにあります。
...
### スケジュール
下記のスケジュールで実施します。
### 9月20日(土) ROBO-ONE予選バトル
9:00 参加者入場、準備出来次第「安全検査」開始(試合番号1～15)(16以降は10:00より)
...
13:20 ROBO-ONE 予選バトルトーナメント（61試合目まで）

16:10　お楽しみ抽選会（参加選手向け）/じゃんけん大会(一般来場者向け)/閉会式

16:30 予選終了

18:00 懇親会(懇親会参加申し込み者のみ)

### 9月21日(日) ROBO-ONE決勝トーナメント
...
14:00 ROBO-ONE 決勝トーナメント 準々決勝/準決勝/３位決定戦/決勝戦

15:10 休憩

15:10 エキシビションマッチ

15:40 じゃんけん大会（会場の全員対象）/表彰式
...
#### ROBO-ONE
　ウェブサイト	https://www.robo-one.com/roboones/index/81

予選バトル	予選バトルトーナメント表は、公開済です。	
...
![mutch_venue](pics/match_venue.png)
